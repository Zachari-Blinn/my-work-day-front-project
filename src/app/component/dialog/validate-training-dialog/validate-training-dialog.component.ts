...
export class ValidateActivityDialogComponent {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: DialogData, private dateHelper: DateHelper, private trainingService: TrainingService, private router: Router) {
  ...
  public validate(): void {
    ...
    this.trainingService.validateTraining(this.selectedTrainingId, {
  ...
  public modifyBeforeValidate(): void {
    ...
    this.router.navigateByUrl(`/training/${this.selectedTrainingId}/modify-before-validate`, { state: { selectedDate: this.selectedDate }});
  }
